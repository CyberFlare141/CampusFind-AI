...
export default function VisualSearchPage() {
  ...
  async function search(event) {
    ...
    } catch (err) { setError(err.message || 'Visual search is temporarily unavailable. Please try again.'); setState('error'); }
  }
