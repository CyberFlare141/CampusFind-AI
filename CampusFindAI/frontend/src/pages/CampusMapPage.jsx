...
export default function CampusMapPage() {
  ...
  return <section className="page-container"><header className="page-header"><h1>AUST Campus Map</h1><p>Ahsanullah University of Science and Technology · Tejgaon, Dhaka, Bangladesh</p></header>
    ...
    {error&&<p role="alert">{error}</p>}<div style={{height:'min(68vh,700px)',minHeight:400,borderRadius:16,overflow:'hidden'}}><MapContainer center={center} zoom={17} scrollWheelZoom style={{height:'100%',width:'100%'}}><TileLayer attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap contributors</a>' url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" />
      <Marker position={center} icon={L.divIcon({className:'',html:'<span style="display:block;width:24px;height:24px;border-radius:50% 50% 50% 0;transform:rotate(-45deg);background:#166534;border:3px solid white;box-shadow:0 1px 6px #555"></span>',iconSize:[24,24],iconAnchor:[12,24]})}><Popup><strong>Ahsanullah University of Science and Technology</strong><br/>Tejgaon, Dhaka, Bangladesh<br/><small>Campus pin is approximate</small></Popup></Marker>
